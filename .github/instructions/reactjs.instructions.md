...
- Don't generate JSDoc comments but do use comments for code that might be hard to read or understand, or to logically organise different sections of large chunks of code
...
- Use React Query queries for GET requests
...
- Follow Tailwind CSS utility-first approach for this project
